...
public sealed class RunConfiguration(JsonObject document, string baseDirectory)
{
    ...
    [
        ...
        new("supervisorTimeout", "--supervisor-timeout", "string", "Positive s/m/h duration; default 90m"),
        ...
        new("continuationTimeout", "--continuation-timeout", "string", "Positive s/m/h duration; default 90m"),
