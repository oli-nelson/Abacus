...
await change('time',10);await change('vertical',.5);
assert.deepEqual((await camera()).axisScale,[10,.5,1]);
...
assert.deepEqual((await camera()).axisScale,[10,.5,1]);assert.equal((await camera()).perspective,0);
...
assert.deepEqual((await camera()).axisScale,[10,.5,1]);assert.equal((await camera()).perspective,1);
