...
assert.match(await evaluate("document.getElementById('selected-current-status').textContent"),/blocked/);
...
await until("document.getElementById('selected-current-status').textContent.includes('in_progress')");
assert.equal(await evaluate("document.getElementById('timeline-stage').dataset.statusTransitions"),'0');
await evaluate("document.getElementById('timeline-motion').value='full';document.getElementById('timeline-motion').dispatchEvent(new Event('change'))");
...
await until("document.getElementById('selected-current-status').textContent.includes('open')");
